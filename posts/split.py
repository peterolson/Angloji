...
split_image("20.jpg", columns=2, rows=5, prefix="p20_")
split_image("vote1.jpg", columns=3, rows=1, prefix="v1_")
split_image("21.jpg", columns=8, rows=8, prefix="p21_", skip=5)
split_image("22.jpg", columns=2, rows=5, prefix="p22_")
split_image("23.jpg", columns=2, rows=5, prefix="p23_", skip=1)
split_image("24.jpg", columns=8, rows=10, prefix="p24_")
split_image("25.jpg", columns=8, rows=6, prefix="p25_")
split_image("26.jpg", columns=6, rows=5, prefix="p26_")
split_image("puzzle1.jpg", columns=4, rows=10, prefix="puz1_", skip=4)
split_image("27.jpg", columns=2, rows=6, prefix="p27_")
split_image("28.jpg", columns=1, rows=4, prefix="p28_")
split_image("29.jpg", columns=7, rows=8, prefix="p29_", skip=4)
split_image("30.jpg", columns=5, rows=5, prefix="p30_")
split_image("31.jpg", columns=9, rows=9, prefix="p31_")
